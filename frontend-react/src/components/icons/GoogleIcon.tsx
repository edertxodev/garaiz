...
export const GoogleIcon: FC<IconProps> = ({ width = 32, height = 32 }) => (
  <svg id="Capa_1" width={width} height={height} version="1.1" viewBox="0 0 150 150" xmlns="http://www.w3.org/2000/svg">
    <style>{`
      .st0 {
        fill: #1a73e8;
      }
