...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    conversations: Attribute.Relation<'plugin::users-permissions.user', 'manyToMany', 'api::conversation.conversation'>
    color: Attribute.Enumeration<['Blue', 'Pink', 'Green', 'Orange', 'Red', 'Yellow']> &
      Attribute.Required &
      Attribute.DefaultTo<'Pink'>
    locale: Attribute.Enumeration<['Es', 'En']> & Attribute.Required & Attribute.DefaultTo<'Es'>
    createdAt: Attribute.DateTime
    updatedAt: Attribute.DateTime
...
export interface ApiConversationConversation extends Schema.CollectionType {
  ...
  attributes: {
    messages: Attribute.Relation<'api::conversation.conversation', 'oneToMany', 'api::message.message'>
    uuid: Attribute.UID & Attribute.CustomField<'plugin::strapi-advanced-uuid.uuid'>
    users: Attribute.Relation<'api::conversation.conversation', 'manyToMany', 'plugin::users-permissions.user'>
    createdAt: Attribute.DateTime
    updatedAt: Attribute.DateTime
    createdBy: Attribute.Relation<'api::conversation.conversation', 'oneToOne', 'admin::user'> & Attribute.Private
    updatedBy: Attribute.Relation<'api::conversation.conversation', 'oneToOne', 'admin::user'> & Attribute.Private
  }
}
...
export interface ApiFeatureFeature extends Schema.SingleType {
  ...
  attributes: {
    login: Attribute.Boolean & Attribute.DefaultTo<true>
    chat: Attribute.Boolean & Attribute.DefaultTo<false>
    name: Attribute.String
    createdAt: Attribute.DateTime
    updatedAt: Attribute.DateTime
    createdBy: Attribute.Relation<'api::feature.feature', 'oneToOne', 'admin::user'> & Attribute.Private
    updatedBy: Attribute.Relation<'api::feature.feature', 'oneToOne', 'admin::user'> & Attribute.Private
  }
}
...
export interface ApiMessageMessage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    conversation: Attribute.Relation<'api::message.message', 'manyToOne', 'api::conversation.conversation'>
    timestamp: Attribute.DateTime & Attribute.Required
    user: Attribute.Relation<'api::message.message', 'oneToOne', 'plugin::users-permissions.user'>
    createdAt: Attribute.DateTime
    updatedAt: Attribute.DateTime
...
export interface ApiNoteNote extends Schema.CollectionType {
  ...
  attributes: {
    ...
    user: Attribute.Relation<'api::note.note', 'oneToOne', 'plugin::users-permissions.user'>
    createdAt: Attribute.DateTime
    updatedAt: Attribute.DateTime
    createdBy: Attribute.Relation<'api::note.note', 'oneToOne', 'admin::user'> & Attribute.Private
    updatedBy: Attribute.Relation<'api::note.note', 'oneToOne', 'admin::user'> & Attribute.Private
  }
}
